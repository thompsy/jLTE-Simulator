...
public final class RandomAlgoIntegTest {
	...
	public void singleUE() throws ConfigurationException, IOException {
		...
		config.setProperty(FieldNames.ALGORITHM, RANDOM_ALGO);
	...
	@Test
	public void withInterferenceAndX2() throws ConfigurationException, IOException {
		Configuration config = IntegConfiguration.getDefaultX2IntegTestConfig();
		config.setProperty(FieldNames.SCENARIO_PATH, "src/test/resources/04-2eNodeBs-2UEs/");
		config.setProperty(FieldNames.ALGORITHM, RANDOM_ALGO);

		SimulationResults results = IntegConfiguration.runTest(config);
		assertEquals(44.221366, results.avergeTput, 0.000001);
		assertEquals(43.45258, results.percentileTput, 0.000001);
	}
}
